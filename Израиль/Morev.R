...
attach(mydata)
plot(Year,xlab="Год",terrorism,ylab="Количество упоминаний",main="частота упоминаний характеристик для страны Израиль",pch=15,col="red",type="b",xlim=c(2000,2014))
...
legend("topleft",inset=0.01,title="Характерики",c("Террорист","Окупация","Терроризм","Наркотики","Насилие","Демократия","Развитие"),lty=c(1,1,1,1,1,1,1),pch=c(15,16,17,18,19,20,21),col=c("red","green","black","orange","yellow","grey","gold"))
max(mytable)
